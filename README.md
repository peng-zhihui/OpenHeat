...
## 24-01-27 修复说明：
由于PlatformIO相关依赖更新，指定platformio.ini文件中platform参数为espressif32@3.5.0

修改u8g2图形库中初始化代码的x轴偏移参数以解决[SSD1306出现的左侧两像素显示错误问题](https://github.com/peng-zhihui/OpenHeat/issues/17)
